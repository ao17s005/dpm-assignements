...
```{r}
library(readxl)
data_steca2018 <- read_excel("~/Documents/GitHub/dpm-assignements/Assignments_Meta-Science/plot_assignment/data/data_steca2018.xlsx") |> clean_names()
View(data_steca2018)
...
# sport success = low and high athlete
# sprot type = team and individual sport type
